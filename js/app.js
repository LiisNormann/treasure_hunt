...
const questions = [
    "How many differences are there between the two pictures? It's definitely not 5 :)",
    "What is ((2*3) + 565 / 5 - 2 + (2*6)) - 2.",
    "What color does hex code #964B00 belong to?",
    "Previously you found the numbers 5 and 127 as your answers to Q1 and Q2, right? What a lovely 4-digit code you've got there! For victory, you must first move down, then right, then down again, and finally right again! Pssst ... start from the left upper corner!"
];
...
//fill progress bar as steps progress
